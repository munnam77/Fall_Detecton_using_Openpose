...
default_email = "moazzemhossain@gmail.com"
data_path = ""              # The default video path
...
def send_alert():
    global target_email
    sender = 'falldetection@gmail.com'
    receiver = [target_email]

    message = """From: From Falling Detection <falldetection@gmail.com>
    To: <test@gmail.com>
    Subject: Fall Alert
...
def Fall(x_speed, y_speed, head_x_speed, head_y_speed, frame, distance):
    ...
    if valid_count > 4 and index - old_frame > 30: 
...
top.title("Fall Detection by Moazzem")
# Menu
menu = Menu(top)
